public class TestGeneric {
    public static void main(String[] args) {
        ...
        DoublyLinkedListGeneric<Integer> integerList = new DoublyLinkedListGeneric<Integer>();
        DoublyLinkedListGeneric<String> stringList = new DoublyLinkedListGeneric<String>();
